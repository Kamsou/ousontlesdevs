  ...
  <div class="min-h-screen flex flex-col relative bg-bg text-text">
    <header class="fixed top-0 left-0 right-0 z-50 px-4 md:px-8 py-4 backdrop-blur-xl bg-bg/80 border-b border-border">
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          <a href="https://github.com/Kamsou/ousontlesdevs" target="_blank" rel="noopener noreferrer" class="hidden lg:flex items-center gap-2 text-text-muted hover:text-text transition-all text-sm font-medium" title="Contribuer au projet">
    ...
    <div v-if="menuOpen" class="fixed inset-0 z-40 bg-bg pt-20 px-6 lg:hidden">
      <nav class="flex flex-col gap-6 py-8">
        ...
        <a href="https://github.com/Kamsou/ousontlesdevs" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 text-text no-underline text-2xl font-medium">
    ...
    <footer class="relative z-[1] text-center py-8 text-text-muted text-sm border-t border-border">
      <p>Fait pour toutes les développeuses par <a href="https://linkedin.com/in/camillecoutens" target="_blank" rel="noopener noreferrer" class="text-text hover:text-primary transition-colors">Camille Coutens</a></p>
    </footer>
  </div>
</template>
