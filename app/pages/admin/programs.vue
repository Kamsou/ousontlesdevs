        ...
        <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              ...
              <span v-if="program.highlight" class="px-2 py-0.5 text-xs bg-primary/20 text-blue-700 dark:text-blue-300 rounded-full">
                Highlight
              </span>
              <span v-if="!program.active" class="px-2 py-0.5 text-xs bg-red-500/20 text-red-700 dark:text-red-300 rounded-full">
                Inactif
              </span>
            </div>
